		...
		if(empty($this->_options)) {
			$this->_options = dispatcherGmp::applyFilters('optionsDefine', array(
				'general' => array(
					...
					'opts' => array(
						'api_domain' => array('label' => __('API Domain', GMP_LANG_CODE), 'desc' => __('Sets domain for google API scripts', GMP_LANG_CODE), 'def' => '', 'html' => 'selectbox', 'options' => array('https://maps.googleapis.com/' => 'https://maps.googleapis.com/', 'http://maps.google.cn/' => 'http://maps.google.cn/'), 'attrs' => 'style="width: 300px;"'),
