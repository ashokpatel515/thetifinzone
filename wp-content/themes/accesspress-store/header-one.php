      ...
      <div class="ak-container clearfix">
        ...
        <div class="right-header-main clearfix">
          <div class="login_link">
            ...
            <div class="welcome-user"> <span class="line"></span>
              <?php _e('Welcome', 'accesspress-store'); ?>
              <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" class="my-account"> <span class="user-name"> <?php echo $current_user->display_name; ?> </span> </a>
          ...
          <div class="cart_block"> <!-- Cart Link -->
            <?php							if (is_woocommerce_activated()){								echo '<div class="view-cart">'; 									echo accesspress_store_cart_link();								echo '</div>';							}						?>
            <?php							if (function_exists('YITH_WCWL')) {								$wishlist_url = YITH_WCWL()->get_wishlist_url();						?>
            <a class="quick-wishlist" href="<?php echo $wishlist_url; ?>" title="Wishlist"> <i class="fa fa-heart"></i> <?php echo "(" . yith_wcwl_count_products() . ")"; ?> </a>
            <?php } ?>
          ...
          <div class="right-header clearfix"> 
            ...
            <div id="menu">
              <?php
                            ...
                            ?>
              <nav id="site-navigation" class="main-navigation" role="navigation"> <a class="menu-toggle">
